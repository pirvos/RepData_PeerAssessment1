...
```
## [1] "This corresponds to the following interval as in the original data: 835"
```
...
```
## [1] "In both cases, the hour of the day with that maximum value is:  8H 35M 0S"
```
...
```
## [1] "The maximum average number of steps per period is:  206.17"
```
...
```
## [1] "Number of NA values in missingSteps is: 0"
```
...
## 2 2012-10-08   9974.857
## 3 2012-11-01   8212.750
## 4 2012-11-04  12277.714
## 5 2012-11-09  12359.714
## 6 2012-11-10  12535.429
## 7 2012-11-14  11790.750
## 8 2012-11-30  12359.714
```
